...
<div class="col-md-3" style='overflow:auto; max-height:85vh'><!--geeft het overzicht (tabel) van de sloten die nog beschikbaar zijn.-->
        ...
        <?php
            ...
            $sqli_Docent = "SELECT DISTINCT Datum FROM tijden_binnen_avond WHERE Afgerond=0 AND Docent_ID='$ID'";
                            ...
                            $row1 = mysqli_fetch_array($Proggresbar_Uitvoer);
                                echo "<tr class='success'>";
                                    ...
                                    echo "<td>";
                                        ?>
                                            <div class="progress">
                                                <div class="progress-bar" role="progressbar" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100" style="width:<?PHP echo ($rowcount2/$rowcount)*100; ?>%">
                                                    <span><?PHP echo round(($rowcount2/$rowcount)*100); ?>%</span>
                                                </div>
                                            </div>
                                        <?php
                                    echo "</td>";
